...
const instagram = 'http://www.instagram.com. .com/'; 
...
async function starts() {
	...
	dark.on('chat-update', async (mek) => {
		try {
			...
			const premium = ["5511934488829@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net","12267740582@s.whatsapp.net"]
...
// recursos anime, random @dark domina vida
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					dark.sendMess(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT MINATO ✨* 」\n*│+ wa.me/5511934488829*╰──────*「 *MINATO * 」*────*\n\n*_SE QUER SER ADMIN DO BOT MINATO _*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
